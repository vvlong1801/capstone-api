...
class AppServiceProvider extends ServiceProvider
{
    protected $bindingServices = [
        ...
        Services\Interfaces\AccountServiceInterface::class => Services\AccountService::class,
        Services\Interfaces\CreatorServiceInterface::class => Services\CreatorService::class,
    ];
    /**
